...
- A boolean
- An array with a length of 3 or less of numbers that are all uint8
...
An array with a length over 3 of numbers that are all uint8 are sent optimally and are not stringified like other arrays.
