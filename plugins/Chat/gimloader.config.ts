...
export default singleConfig({
    ...
    needsLibs: ["Communication | https://raw.githubusercontent.com/Gimloader/client-plugins/refs/heads/main/build/libraries/Communication.js"],
    gamemodes: ["2d"],
    changelog: ["Update to use Communication library"]
});
